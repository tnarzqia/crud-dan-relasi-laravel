...
<div class="container">
    <div class="row">
        <div class="col">
            <h1 class="h3 mb-0 text-gray-800 mb-4">Data Kelas</h1>
            <div class="card">
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('clas.edit', [$d->id]) }}" class="btn btn-warning">Edit</a>

                                        <form action="{{ route('clas.destroy', [$d->id]) }}" method="post">
                                            @csrf
